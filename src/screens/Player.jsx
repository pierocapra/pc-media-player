...
export default function Player({ playlistData, handleTrackOnClick, currentTrack }) {
          ...
          <ul className="playlist">
            ...
            <div className="playlist-content">
              {playlistData?.tracks?.items?.map((track) => (
                <li
                  key={track.track.id}
                  className={`track ${currentTrack?.id === track.track.id ? 'active' : ''}`}
                  onClick={() => handleTrackOnClick(track.track, track.track.preview_url)}
                >
